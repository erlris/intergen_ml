...
traindta <- select(traindta,-eduy_child,-matches("meanpearn"))
...
#save.image("models/modelcomp_ranks.RData")
...
set.seed(10101)
level_fit <- train(earncdf_child ~ earncdf_father_age_25to29, 
                   data=training,
                   trControl=tc,
                   tuneLength=1,
                   method="lm",
...
#Aggregating data####
#load("models/modelcomp_ranks.RData")
...
ggsave("graphs/modelcomp_ranks_training_violin.pdf",
       height=7,width=7)
...
ggsave("graphs/modelcomp_ranks_training_pointrange.pdf",
       height=7,width=7)

#Out of Sample####
modellist <- list("Rank Rank"=level_fit,
                  "Ranger"=ranger_fit,
...
preds[["Rank Rank"]]  <- predict(level_fit,newdata=testing) 
...
ggsave("graphs/modelcomp_ranks_testing.pdf",
       height=7,width=7)
...
ggsave("graphs/modelcomp_ranks_times.pdf",
       height=7,width=7)
...
ggsave("graphs/modelcomp_ranks_scatter.pdf",
       width=16,height=9)